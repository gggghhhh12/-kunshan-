...
<html>
  ...
  <body>
    ...
    <table style="width:98%; border-collapse:collapse; border-spacing:0;" id="idData"> 
            ...
            <c:forEach var="browseEpDataDown" items="${browseEpDataDowns}">
                <tr>
                    <td width="25%">${browseEpDataDown.jobname }</td>
                    <td width="25%">${browseEpDataDown.jobdiploma }</td>
                    <td width="25%">${browseEpDataDown.reqnum }</td>
                    <td width="25%">${browseEpDataDown.jobkind }</td>
