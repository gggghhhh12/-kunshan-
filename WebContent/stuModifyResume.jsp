...
<script type="text/javascript" src="./js/stuModifyResume.js">
	</script>
</head>
			...
			<form action="servlet/StuHandleModifyResume" method="post">
				...
				<div class="basicinfo">
					...
					<dl>
						<dt>出生日期</dt>
						<dd>
							<!--<input type="text" name="biryear" style="width:60px;height:30px" value="${birYear }">年
						<input type="text" name="birmonth" style="width:60px;height:30px" value="${birMonth }">月
						<input type="text" name="birday" style="width:60px;height:30px" value="${birDay }">日-->
				...
				<div class="education">
					...
					<dl>
						<dt>时间</dt>
						<dd>
							<!-- <input type="text" name="eduyear" style="width:60px;height:30px" value="${entYear }">年
						...
						<input type="text" name="edumonth1" style="width:60px;height:30px" value="${gradMonth }">月&nbsp;(最高学历) -->
							<input type="date" style="width: 180px; height: 30px"
								placeholder="开始时间" name="entertime" id="entertime"
								value="${entertime }">到&nbsp; <input type="date"
								style="width: 180px; height: 30px" placeholder="结束时间"
								name="gradtime" id="gradtime" value="${gradtime }">&nbsp;(最高学历)
						</dd>
					</dl>
					<dl>
						<dt>学校</dt>
					...
					<dl>
						...
						<dd>
							<select name="edudiploma">
								<option value="专科"
									<c:if test="${education.edudiploma eq '专科'}"> selected="selected"</c:if>>专科</option>
								<option value="本科"
					...
					<dl>
						...
						<dd>
							<textarea id="eduduty" name="eduduty"
								style="width: 300px; height: 100px">${education.eduduty }</textarea>
						</dd>
					</dl>
					<dl>
						<dt>在校奖励</dt>
						<dd>
							<textarea id="eduaward" name="eduaward"
								style="width: 300px; height: 100px">${education.eduaward }</textarea>
						</dd>
					</dl>
					<dl>
						<dt>社会实践</dt>
						<dd>
							<textarea id="eduprictise" name="eduprictise"
								style="width: 300px; height: 100px">${education.eduprictise }</textarea>
						</dd>
					</dl>
					<dl>
						<dt>海外学习经历</dt>
				...
				<div class="jobintention">
					...
					<dl>
						...
						<dd>
							<textarea id="evaluation" name="evaluation"
								style="width: 420px; height: 100px">${jobIntention.evaluation }</textarea>
						</dd>
					</dl>
					<dl>
						<dt>求职地点</dt>
					...
					<div class="button">
						<input type="submit" value="保 存" onclick="return myfunction()">
					</div>
				</div>
			</form>
		</div>
