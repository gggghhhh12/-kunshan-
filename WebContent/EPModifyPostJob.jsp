						...
						<dl>
							...
							<dd>
								<textarea name="jobdescribe" style="width: 300px; height: 100px"
									placeholder="不超过1000字，按点换行">${EPPostJob.jobdescribe }</textarea>
							</dd>
						</dl>
						<dl>
							<dt>岗位职责</dt>
							<dd>
								<textarea name="jobduty" style="width: 300px; height: 100px"
									placeholder="不超过1000字，按点换行">${EPPostJob.jobduty }</textarea>
							</dd>
						</dl>
						<dl>
							<dt>技术要求</dt>
							<dd>
								<textarea name="techrequest" style="width: 300px; height: 100px"
									placeholder="不超过1000字，按点换行">${EPPostJob.techrequest }</textarea>
							</dd>
						</dl>
						<dl>
							<dt>职能类别</dt>
							<dd>
								<input id="jobkind" type="text" name="jobkind"
									style="width: 200px; height: 30px"
									value="${EPPostJob.jobkind }"><a class="ajobkind"></a>
							</dd>
						</dl>
						<dl>
							<dt>上班地址</dt>
