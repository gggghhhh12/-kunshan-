...
public class AdminModifyEPData1Servlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("AdminModifyEPData1Servlet");
		...
		request.getRequestDispatcher("AdminShowEPDataServlet").forward(request, response);
	}
